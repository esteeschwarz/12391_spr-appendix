...
// wenn das so steht, dann gibt es nur für einen satz die ergebnisse aus
  //  var save = result;
     
 // const xmlhttp = new XMLHttpRequest();
 
  //xmlhttp.open("GET", "testwrite.php?q=" + save);
 // xmlhttp.send();
...
// Display data from the object:
  ...
  /*  const xmlhttp = new XMLHttpRequest();
 //var save = this.Experiment.prototype.createResults(); //008undefined thisexp...
// var save = this.createResults();009 hängt ohne meldung
// var save = this.getData(); passiert nix
// var save = data;
 xmlhttp.open("GET", "testwrite.php?q=" + save);
  xmlhttp.send(); 
*/
...
Experiment.prototype.extractdata = function(){
 const xmlhttp = new XMLHttpRequest();
 var save = this.getData();
 xmlhttp.open("GET", "testwrite.php?q=" + save);
 xmlhttp.send(); 
};
...
// var save = this.createResults();009 hängt ohne meldung
// var save = this.getData(); passiert nix
// var save = data; //011passiert nix
//var save = dataresults(); 012 passiert nix
xmlhttp.open("GET", "testwrite.php?q=" + save);
  xmlhttp.send(); 
...
//------------------savedata-------------------
 /*     so funktioniert schreiben mit daten, aber es wird nur das datenschema, nicht die variablen ausgegeben...
     var save = this.getData;
 ...
 /*      var save = data;
  ...
  xmlhttp.send();
    */
    ...
    //so werden die richtigen variablen übergeben, aber es tritt ein schreibfehler auf... mit POST
 /*   var save = this.getData();
...
extractdata = function(){
    var save = Experiment.prototype.createResults();
     const xmlhttp = new XMLHttpRequest();
...
//rrrrrrrrRRRRRR-----------------------------------------------------------------------RESULTS


Experiment.prototype.getData = function(save, result){ //variablen eingefügt
    var lhq = "\"";
    var rhq = "\"";
...
// try insert from above results : only empty results headline... general for check output: the php writes the variable into testwrite.txt
 /* 
     var save = elapsedTime;// 007 no variable //002 var save= results Experiment.prototype.getData() 003 max call stack size exceeded
...
return savea;}
};*/ //----------> übergibt richtige var, php load error 303, mit POST
///////////////////////////////////////////////////////////////////////////11252/////////////////////////////////////////////////// this works /////////////////////////
const saved = result;
//const xmlhttp = new XMLHttpRequest();
 
 //xmlhttp.open("POST", "testwrite.php?q=" + saved); >>>>>> so funktioniert jquery write von hier.
 $.post("testwrite.php",
  {
    q: "Donald Duck",
    data: saved
  ...
  /* --------------inholdne testwrite.php----------------
$txt = $_POST["data"]; //request-  mit q funktioniert, duck wird geschrieben
$myfile = fopen("testwrite.txt", "a+") or die("Unable to open file!");
//sleep(1);

// get the q parameter from URL
//$txt = $_GET["q"];

//echo file_put_contents("testwrite.txt", $txt, FILE_APPEND);
//sleep(1);


//echo "NAME:" . $_GET["name"]; 
//echo "EMAIL:" . $_GET["email"]; 
//echo "report:" . $_GET["sent"];
...
/* 
 ...
 saved: function() {
    ...
    // extractdata
// this.result = undefined this.getadata=ganze funktion, 
 //  var save = Experiment.prototype.getData(); //004 screen length
   
 /*   -----------------------*/
 // function extractdata(save){ //ohne


//let save = save + result;
 //return save;// ohne, here exports richtige werte, aber fehler beim laden des php
 //} 
 // var save = document.getElementById("essai").innerHTML;
 //----------to change div with results---------------------------------document.getElementById("essai").innerHTML = "report:" + save;
 // const xmlhttp = new XMLHttpRequest();
 
 // xmlhttp.open("POST", "testwrite.php?q=" + save);
 // xmlhttp.send();    
 /*    --------------------
   const xmlhttp = new XMLHttpRequest();
// var save = this.getData();//maximum call stack exceeded 728 

// var save = result; 006  string doesnt match pattern
  xmlhttp.open("", "testwrite.php?q=" + save);
  xmlhttp.send();
*/
return result; ////////////////////////////////////////////////////////////////////////// MIND
  /*   005 wird nicht ausgeführt: auszerhalb return result, funktion zu ende...
       var save = this.getData(); 
...
var xmlhttp = new XMLHttpRequest();
        xmlhttp.onreadystatechange = function() {
            ...
            //    document.getElementById("essai").innerHTML = this.responseText;
        str = Experiment.prototype.getData(save);
            }
        };
   //     xmlhttp.open("GET", "testwrite.php?q=" + str, true);
     //   xmlhttp.send();
         var save = str;



 document.getElementById("essai").innerHTML = "report:" + save; 
...
var save = document.getElementById("essai").innerHTML;
  ...
  */
/* 
   //-----------------------------------s------------------------ THIS IS THE CRITICAL STELLE --------------------------------------------------------------
 //  screen lenght issue
function extractdata(run){ //function wird 1853 am ende des scripts aufgerufen, die fraglichen ergebnisse liegen in der experiment.prototype.getdata funktion hierdrüber
var save = Experiment.prototype.createResults();
//var save = 1 + ". run";     // das speichern funktioniert mit dieser variable, wenn die hierdrüber deaktiviert ist. 
  const xmlhttp = new XMLHttpRequest();
...
*/
/*  
// nur zum sichern der funktionierenden routine kopiert
function extractdata(run){ //function wird am ende des scripts aufgerufen, die fraglichen ergebnisse liegen in der experiment.prototype.getdata funktion hierdrüber
var save = Experiment.prototype.getData();
//var save = run + ". run";     // das speichern funktioniert mit dieser variable, wenn die hierdrüber deaktiviert ist. 
  const xmlhttp = new XMLHttpRequest();
...
// extractdata();// aufrufen 100 in index aufrufen---------------------------------------------------------------------------------------------
...
/* 
   const xmlhttp = new XMLHttpRequest();
 var save = this.Experiment.prototype.createResults();
  xmlhttp.open("", "testwrite.php?q=" + save);
  xmlhttp.send();
   */
